...
def add_args_maketree(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    optional.add_argument('--n_data',                 type=int,             default=516,              help='(Defaults to 516). Number of data to put in the tree.')
    optional.add_argument('--batch_size',             type=int,             default=516,              help='(Defaults to 516). Batch size.')
