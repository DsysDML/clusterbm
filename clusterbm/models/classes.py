...
class Ebm(ABC):
    ...
    def init_sampling(
        ...
        Args:
            ...
            checkpoints (Iterable[int] | None, optional): List of checkpoints to use. If None, all checkpoints present in the model's file are used. Defaults to None.
        ...
        pbar = tqdm(total=(len(checkpoints) - 1) * it_mcmc, colour='red', leave=False, dynamic_ncols=True, ascii='-#')
        for idx, ep in enumerate(checkpoints[1:]):
